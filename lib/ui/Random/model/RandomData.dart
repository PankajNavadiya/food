class GetRandomData {
  List<GetRandomItem>? meals;

  GetRandomData({this.meals});

  GetRandomData.fromJson(Map<String, dynamic> json) {
    if (json['meals'] != null) {
      meals = <GetRandomItem>[];
      json['meals'].forEach((v) {
        meals!.add(new GetRandomItem.fromJson(v));
      });
    }
  }
...
class GetRandomItem {
  ...
  GetRandomItem.fromJson(Map<String, dynamic> json) {
    idMeal = json['idMeal'];
